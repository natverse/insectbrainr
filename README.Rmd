...
```
[![Travis-CI Build Status](https://api.travis-ci.org/natverse/insectbrainr.svg?branch=master)](https://travis-ci.org/natverse/insectbrainr)
...
```{r package, out.width = "400px", echo=FALSE, fig.align = "center"}
...
```{r natverse, out.width = "400px", echo=FALSE, fig.align = "center"}

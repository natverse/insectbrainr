...
[![Coverage status](https://codecov.io/gh/natverse/insectbrainr/branch/master/graph/badge.svg)](https://codecov.io/github/natverse/insectbrainr?branch=master)
[![Docs](https://img.shields.io/badge/docs-100%25-brightgreen.svg)](http://jefferislab.github.io/insectbrainr/reference/)<img src="https://raw.githubusercontent.com/natverse/insectbrainr/master/inst/images/hex-natverse_logo.png" width="30px" style="display: block; margin: auto;" />


```{r package, out.width = "300px", echo=FALSE, fig.align = "center"}
...
```{r natverse, out.width = "300px", echo=FALSE, fig.align = "center"}
